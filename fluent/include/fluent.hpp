...
private:
    ...
    size_t handleWrite(const std::vector<std::string>& tok, size_t idx);
    size_t handleRead(const std::vector<std::string>& tok, size_t idx);
    size_t handleAppend(const std::vector<std::string>& tok, size_t idx);
